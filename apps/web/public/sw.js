/* Teledrive root Service Worker.
 * 1) Offline shell: network-first dengan fallback cache (ruang-v1).
 * 2) Media streaming: 206 Partial Content untuk /media/stream/:objectId.
 ...
 *    Harus di scope root karena SW hanya mencegat fetch dari halaman yang ia kontrol. */

const CACHE = 'ruang-v1';
const SHELL = ['/'];
